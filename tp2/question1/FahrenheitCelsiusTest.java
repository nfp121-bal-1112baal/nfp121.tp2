...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_fahrenheitEnCelsius() {
        ...
        //addition de ma "assertEquals"
        assertEquals("   200 °F -> 93.3 °C ?",93.3,question1.FahrenheitCelsius.fahrenheitEnCelsius(200), 0.1);
        assertEquals("   165 °F -> 73.8 °C ?",73.8,question1.FahrenheitCelsius.fahrenheitEnCelsius(165), 0.1);
        //Addition d'un "assertTrue"
        assertTrue("165°F < 200°F",question1.FahrenheitCelsius.fahrenheitEnCelsius(165)<question1.FahrenheitCelsius.fahrenheitEnCelsius(200));
    }
